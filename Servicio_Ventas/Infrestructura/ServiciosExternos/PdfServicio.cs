...
namespace Servicio_Ventas.Infrestructura.ServiciosExternos
{
        ...
        public byte[] GenerarComprobanteVenta(DataTable dt)
        {
            ...
            var documento = Document.Create(contenedor =>
            {
                contenedor.Page(pagina =>
                {
                    ...
                    pagina.Content().PaddingVertical(20).Column(col => {
                    ...
                    pagina.Footer().AlignRight().Text($"{DateTime.Now:dd/MM/yyyy HH:mm} - {nombreEmpleado}").Italic();
                });
            });
